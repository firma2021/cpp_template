...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.4.9"
  WORKING_DIRECTORY "/mnt/c/Users/kiki/CLionProjects/cpp_project_template/build/debug/_deps/doctest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/c/Users/kiki/CLionProjects/cpp_project_template/build/debug/_deps/doctest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/c/Users/kiki/CLionProjects/cpp_project_template/build/debug/_deps/doctest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
